...
def manageTeam(request):
    ...
    if request.method == 'GET':
        return render(
            request, 'teams.html',
            {'teams': teams, 'all_pokemons': all_pokemons}
        )
...
def battle(request):
    try:
        ...
        team1_hp = sum(
            get_pokemon_hp(pokemon) for pokemon in [
                team1.pokemon_1, team1.pokemon_2, team1.pokemon_3,
                team1.pokemon_4, team1.pokemon_5, team1.pokemon_6
            ]
        )
        team2_hp = sum(
            get_pokemon_hp(pokemon) for pokemon in [
                team2.pokemon_1, team2.pokemon_2, team2.pokemon_3,
                team2.pokemon_4, team2.pokemon_5, team2.pokemon_6
            ]
        )
